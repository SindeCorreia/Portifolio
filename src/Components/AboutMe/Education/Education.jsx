    ...
    return (
        <div className='Educationfather'>     
            ...
            <div className='downloadpdf'>
              <a href={process.env.PUBLIC_URL + '/Sinde_Correia_Web_Developer.pdf'} download="Sinde_Correia_Web_Developer.pdf" className='linkimgdownloadcv'> <img src={Dowload} alt="CURRICULUM" id="imgdownloadcv"/>DOWNLOAD RESUME </a>
